  ...
  <div class="mx-auto w-full max-w-3xl">
    ...
    <div class="mt-10 grid gap-6 grid-cols-1 sm:grid-cols-2">
      ...
      >
        ...
        >
          <div
            class="absolute -top-24 -left-24 h-52 w-52 rounded-full bg-indigo-100 blur-2xl"
          ></div>
          <div
            class="absolute -bottom-24 -right-24 h-52 w-52 rounded-full bg-sky-100 blur-2xl"
          ></div>
        </div>
        ...
        <div class="relative">
          <div class="flex items-start justify-between">
            ...
            >
              ...
              >
                <path
                  d="M9 2H7a5 5 0 0 0-5 5v10a5 5 0 0 0 5 5h6a5 5 0 0 0 5-5V7a5 5 0 0 0-5-5h-2"
                />
      ...
      <Teleport to="body">
        ...
        <!-- modal (center / mobile은 풀스크린 바텀시트 느낌) -->
        <div
          v-if="isChatOpen"
      ...
      >
        ...
        >
          <div
            class="absolute -top-24 -left-24 h-52 w-52 rounded-full bg-emerald-100 blur-2xl"
          ></div>
          <div
            class="absolute -bottom-24 -right-24 h-52 w-52 rounded-full bg-sky-100 blur-2xl"
          ></div>
    ...
    <div class="mt-10 space-y-4">
      ...
      >
        ...
        >
          <div
            class="absolute -top-24 -right-24 h-52 w-52 rounded-full bg-indigo-100 blur-2xl"
          ></div>
        </div>
        ...
        <div class="relative flex items-center justify-between gap-4">
          ...
          <span class="text-sm font-semibold text-indigo-600"> 열기 → </span>
        </div>
      </button>
      ...
      >
        ...
        >
          <div
            class="absolute -top-24 -left-24 h-52 w-52 rounded-full bg-rose-100 blur-2xl"
          ></div>
        </div>
        ...
        <div class="relative flex items-center justify-between gap-4">
          ...
          <span class="text-sm font-semibold text-rose-600"> 전화 → </span>
        </div>
      </button>
    </div>

    <!-- 하단 링크 -->
    <div v-if="user.role === false" class="mt-10 text-center">
      <router-link
        :to="{ name: 'license' }"
...
const erListClick = () => {
  router.push({ name: "erlist" }); // 라우트 이름 프로젝트에 맞게
};
